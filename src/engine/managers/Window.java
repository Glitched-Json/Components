...
public final class Window {
    ...
    @Contract(" -> new")
    public static @NotNull Vector4i getFrameSize() {int[][] f = new int[4][1]; glfwGetWindowFrameSize(id, f[0], f[1], f[2], f[3]); return new Vector4i(f[0][0], f[1][0], f[2][0], f[3][0]);}
    @Contract(" -> new")
    public static @NotNull Vector2i getPosition() {int[][] p = new int[2][1]; glfwGetWindowPos(id, p[0], p[1]); return new Vector2i(p[0][0], p[1][0]);}
    @Contract(" -> new")
    public static @NotNull Vector2i getSize() {int[][] s = new int[2][1]; glfwGetWindowSize(id, s[0], s[1]); return new Vector2i(s[0][0], s[1][0]);}
