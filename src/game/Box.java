...
public class Box extends Entity {
    ...
    public Box(Number x, Number y, Number z) {
        ...
        stateAnimation.addKeyframe(new KeyFrame().setPos(0,  0, 0).setRotation(0, 0,  0).set("c", 1  , 1  , 1));
        stateAnimation.addKeyframe(new KeyFrame().setPos(0,  1, 0).setRotation(0, 0, 45).set("c", 1  , 0  , 0));
        stateAnimation.addKeyframe(new KeyFrame().setPos(0,  0, 0).setRotation(0, 0, 45).set("c", 0.5, 0.5, 0));
        stateAnimation.addKeyframe(new KeyFrame().setPos(0, -1, 0).setRotation(0, 0, 45).set("c", 0  , 1  , 0));
        stateAnimation.addKeyframe(new KeyFrame().setPos(0,  0, 0).setRotation(0, 0,  0).set("c", 1  , 1  , 1));
    }
